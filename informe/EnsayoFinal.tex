...
\begin{document}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|l|l|l|p{5.8cm}|}
            ...
            \hline
            Aplicación & \texttt{43362480A} & \texttt{172.16.90.206} & nginx, frontend React, backend FastAPI y Uvicorn \\
            \hline
...
DB_NAME
    ...
    \begin{itemize}
        ...
        \item \texttt{models.py}: declara los modelos \texttt{Post}, \texttt{Profile} y \texttt{Changelog}.
    ...
    La base de datos utiliza tres entidades principales:
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|l|p{9cm}|}
            ...
            \hline
            \texttt{changelog} & Registra versiones o cambios relevantes del proyecto. \\
            \hline
        \end{tabular}
    ...
    \begin{itemize}
        ...
        \item Registrar entradas del registro de cambios.
    \end{itemize}
...
location /api/ {
    ...
    La consigna solicita que el informe en PDF esté disponible desde el blog. Para cumplirlo, la página \texttt{/about} incluye un enlace a:

    \begin{verbatim}
/static/informe.pdf
    \end{verbatim}

    Este archivo debe copiarse al contenedor de aplicación como recurso estático, de modo que pueda descargarse desde el navegador y también adjuntarse en la entrega de la tarea.
