...
/var/www/blog/dist/static/informe.pdf
    ...
    Como mejora adicional, se incorporaron métricas del sistema en tiempo real mediante Server-Sent Events, un diagrama interactivo de la infraestructura con estado de los servicios y un visor del esquema de la base de datos, lo que convierte al blog en una entrega más completa y demostrable durante la defensa presencial.
\end{document}
